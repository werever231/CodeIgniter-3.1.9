...
<html>
	...
	<body id="top">
		...
		<!-- Header -->
			<header id="header">
				<div class="content">
					<h1><a href="#">Trading Games App</a></h1>
					<p>Una App Genial para compartir videojuegos<br />
					<!--<a href="http://html5up.net">HTML5 UP</a></p>-->
					<ul class="actions">
						<li><a href="#" class="button special icon fa-download">Descargar</a></li>
						<li><a href="#one" class="button icon fa-chevron-down scrolly">Conozca la App</a></li>
					</ul>
				</div>
				<div class="image phone"><div class="inner"><img src="<?php echo base_url(); ?>images/screen.jpg" alt="" /></div></div>
			</header>
			...
			<section id="two" class="wrapper">
				<div class="inner alt">
					<section class="spotlight">
						<div class="image"><img src="<?php echo base_url(); ?>images/juegos.jpg" alt="" /></div>
						<div class="content">
							<h3>agregar videojuegos que tengas disponibles.</h3>
							<p>Sube las fotografias de tus videojuegos para que alguien más pueda ver opciones y disfrutarlos, al igual tu podras ver juegos de otros usuarios e intercambarlos.</p>
						</div>
					</section>
					<section class="spotlight">
						<div class="image"><img src="<?php echo base_url(); ?>images/star.png" alt="" /></div>
						<div class="content">
							<h3>Agrega juegos favoritos</h3>
							<p>Podras agregar juegos favoritos para despues contactar al dueño del mismo y poder cambiarlo.</p>
						</div>
					</section>
					<section class="spotlight">
						<div class="image"><img src="<?php echo base_url(); ?>images/sharing.png" alt="" /></div>
						<div class="content">
							<h3>Registro en la app</h3>
							<p>Podrás registrate para compartir juegos, ver juegos disponibles para intercambiar.</p>
						</div>
					</section>
